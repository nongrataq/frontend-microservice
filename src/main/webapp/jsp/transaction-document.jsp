...
<html>
<head>
    <title>Документ транзакции</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<main>
    <div class="container">
        <h2>Документ транзакции</h2>
        <div class="document-block">
            <div class="doc-header">
                <h3>Акт о проведении операции</h3>
            ...
            <div class="doc-content">
                <div class="doc-row">
                    ...
                    <span><c:out value="${transaction.id}"/></span>
                </div>
                <div class="doc-row">
                    <strong>Дата:</strong>
                ...
                <div class="doc-row">
                    <strong>Сумма:</strong>
                    <span><c:out value="${transaction.amount}"/></span>
                </div>
                <div class="doc-row">
                    <strong>Описание:</strong>
                    <span><c:out value="${transaction.description}"/></span>
                </div>
            </div>
        </div>
